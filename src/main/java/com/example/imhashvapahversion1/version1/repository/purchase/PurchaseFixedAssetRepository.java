...
public interface PurchaseFixedAssetRepository extends CrudRepository<PurchaseFixedAsset,Long> {

    @Query("Select p from PurchaseFixedAsset p  WHERE p.purchaseDate>=:startDate ")
    ArrayList findByRangeStart(@Param("startDate") Date startDate);
    @Query("Select p from PurchaseFixedAsset p  WHERE p.purchaseDate>=:endDate ")
    ArrayList findByRangeEnd(@Param("endDate") Date endDate);
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.companySupplier s  WHERE p.purchaseDate>=:startDate AND s.id=:companySupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.companySupplier s  WHERE p.purchaseDate<=:endDate AND s.id=:companySupplierId")
    ArrayList findByRangeEndAndCompanySupplierId(@Param("endDate") Date endDate,@Param("companySupplierId") Long companySupplierId);
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.companySupplier s  WHERE p.purchaseDate>=:startDate and p.purchaseDate<=:endDate AND s.id=:companySupplierId")
    ...
    //IndividualSupplier
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.individualSupplier s  WHERE p.purchaseDate>=:startDate AND s.id=:individualSupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.individualSupplier s  WHERE p.purchaseDate<=:endDate AND s.id=:individualSupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.individualSupplier s  WHERE p.purchaseDate>=:startDate and p.purchaseDate<=:endDate AND s.id=:individualSupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.privateEntrepreneurSupplier s  WHERE p.purchaseDate>=:startDate AND s.id=:privateEntrepreneurSupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.privateEntrepreneurSupplier s  WHERE p.purchaseDate<=:endDate AND s.id=:privateEntrepreneurSupplierId")
    ...
    @Query("Select p from PurchaseFixedAsset p INNER JOIN p.privateEntrepreneurSupplier s  WHERE p.purchaseDate>=:startDate and p.purchaseDate<=:endDate AND s.id=:privateEntrepreneurSupplierId")
