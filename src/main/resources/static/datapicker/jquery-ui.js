   ...
   allowing multiple different settings on the same page. */
    ...
    function Datepicker() {
        ...
        this.regional[ "" ] = { // Default regional settings
            ...
            dayNames: [ "Երկուշաբթի", "Երեքշաբթի", "Չորեքշաբթի", "Հինգշաբթի", "Ուրբաթ", "Շաբաթ", "Կիրակի" ], // For formatting
            dayNamesShort: [ "Երկ", "Երեք", "Չորեք", "Հինգ", "Ուր", "Շաբ", "Կիր" ], // For formatting
            dayNamesMin: [ "Եր","Երե","Չո","Հի","Ուր","Շա","Կի" ], // Column headings for days starting at Sunday
